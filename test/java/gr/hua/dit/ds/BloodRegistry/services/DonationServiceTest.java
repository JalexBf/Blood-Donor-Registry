...
public class DonationServiceTest {
    ...
    private Application application; // Declare Application
    ...
    void setUp() {
        ...
        bloodDonor.setApplication(application);
    ...
    void testCreateDonation_Success() {
        ...
        testApplication.setStatus(Status.APPROVED);
        bloodDonor.setApplication(testApplication);
